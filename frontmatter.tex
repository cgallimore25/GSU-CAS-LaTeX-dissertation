...
\titlepage\clearpage               % Title page   (gsudiss.cls \titlepage)
\abstractpage\clearpage            % Abstract page (gsudiss.cls \abstractpage)
...
\prefacepage                 % The preface page is optional.
\clearpage                             % Does nothing if no "preface.tex" file exists.
