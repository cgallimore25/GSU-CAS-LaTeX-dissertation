...
% \setlength\bibitemsep{0pt}            % if using biblatex, do this for double-spaced bib
\singlespacing
% \setlength\bibitemsep{2\baselineskip}   % do this for single-spaced refs, double between entries
\setlength\bibitemsep{\baselineskip}   % do this for single-spaced refs, double between entries
